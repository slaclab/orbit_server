...
INCLUDES = -I${EPICS_BASE}/include -I${EPICS_BASE}/include/os/Linux -I${EPICS_BASE}/include/os/Darwin -I${EPICS_BASE}/include/compiler/clang -I${EPICS_BASE}/../pvxs/include
LFLAGS = -L${EPICS_BASE}/lib/${EPICS_HOST_ARCH} -L${EPICS_BASE}/lib/${EPICS_HOST_ARCH} -L${EPICS_BASE}/../pvxs/lib/${EPICS_HOST_ARCH}
